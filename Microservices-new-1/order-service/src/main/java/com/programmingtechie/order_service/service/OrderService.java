...
public class OrderService {
    ...
    public void  placeOrder(OrderRequest orderRequest) {
      ...
      order.setOrderLineIntemsList(orderLineItems);
        List<String> skuCodes = order.getOrderLineIntemsList().stream().map(OrderLineItems::getSkuCode).toList();
            skuCodes.stream().forEach(System.out::println);
